...
PACKAGES=("sway" "swaybg" "swaylock" "swayidle" "kitty" "thunar" "thunar-volman" "thunar-archive-plugin" "vlc" "rhythmbox" "shotwell" "mpv" "gnome-disk-utility" "kdeconnect" "file-roller" "zathura" "zathura-pdf-poppler" "git" "base-devel" "zsh" "waybar" "wlogout" "mako" "wofi" "copyq" "bluez" "bluez-utils" "brightnessctl" "clang" "cmake" "dmidecode" "fzf" "zoxide" "starship" "gedit" "nano" "neovim" "htop" "cava" "bpytop" "gnome-keyring" "go" "man-db" "neofetch" "mariadb" "nethogs" "network-manager" "man-db" "network-manager-applet" "nodejs" "npm" "ntfs-3g" "nwg-look" "nwg-drawer" "openssh" "polkit-gnome" "wine" "winetricks" "wine-mono" "wine-gecko" "python-pip" "rustup" "slurp" "sshfs" "subversion" "unzip" "ttf-fonts-awesome" "ttf-nerd-fonts-symbols" "udisks2" "wget" "curl" "wl-clipboard" "wlroots" "xdg-desktop-portal-wlr")
