...
PACKAGES=("sway" "swaybg" "swaylock" "swayidle" "hyprland" "hyprpaper"  "hyprlock" "hypridle" "kitty" "thunar" "thunar-volman" "thunar-archive-plugin" "vlc" "rhythmbox" "shotwell" "flameshot" "mpv" "gnome-disk-utility" "kdeconnect" "file-roller" "zathura" "zathura-pdf-poppler" "git" "base-devel" "zsh" "waybar" "wlogout" "mako" "wofi" "copyq" "bluez" "bluez-utils" "brightnessctl" "clang" "cmake" "dmidecode" "fzf" "zoxide" "starship" "gedit" "nano" "neovim" "htop" "cava" "bpytop" "gnome-keyring" "go" "man-db" "neofetch" "mariadb" "nethogs" "network-manager" "network-manager-applet" "nodejs" "npm" "ntfs-3g" "nwg-look" "openssh" "polkit-gnome" "python-pip" "rustup" "slurp" "sshfs" "subversion" "unzip" "ttf-fonts-awesome" "ttf-nerd-fonts-symbols" "udisks2" "wget" "curl" "wl-clipboard" "wlroots" "xdg-desktop-portal-wlr" "hyprpaper-engine")
